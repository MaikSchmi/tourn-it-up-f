...
function TournamentCreate() {
  ...
  const handleFormSubmit = async (e) => {
    ...
    const formDetails = {
      ...
      try {
        const newTournament = await axios.post(`${import.meta.env.BASE_URL_API}/tournaments/create`, {formDetails})
  ...
  useEffect(() => {
    if (professionsRequired) {
      document.getElementById("professions-list").classList.remove("form-not-loaded")
    } else {
      document.getElementById("professions-list").classList.add("form-not-loaded")
    }
  }, [professionsRequired])
